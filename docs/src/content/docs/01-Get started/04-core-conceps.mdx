...
Each face is represented by a number from 0 to 5. You can identify faces using the [`Face`](/docs/others/types#face-enum) enum.
...
Each 2D array follows this structure:
...
For state helper functions, see [Utilities](/docs/others/utilities).
